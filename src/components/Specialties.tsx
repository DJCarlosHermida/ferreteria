  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-16">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <p className="font-display text-sm tracking-[0.3em] text-red">RUBROS</p>
          <h2 className="mt-2 font-display text-3xl uppercase text-cream sm:text-5xl">Lo que más consultan</h2>
          <p className="mt-3 max-w-lg text-sm text-muted">
            Recorré las categorías, elegí el producto y mandá la consulta armada por WhatsApp.
          </p>
        </div>
        <Link
          to="/catalogo"
  ...
  return (
    ...
    >
      ...
      <div className={`relative flex h-full flex-col justify-end ${compact ? "p-4" : "p-6"}`}>
        <p className="font-display text-xs tracking-[0.28em] text-red">CATEGORÍA</p>
