...
export function BrandMark({ size = "md" }: { size?: "sm" | "md" | "lg" }) {
  ...
  return (
    <Link to="/" className="inline-flex items-center gap-2 text-cream">
      <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-red text-cream shadow-[0_0_18px_rgba(224,138,42,0.45)]">
        <Wrench className={icon} strokeWidth={2.2} />
      </span>
